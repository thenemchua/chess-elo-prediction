...
print('\nInitializing model...')
# Initializing model
model = dl_models_final.initialize_CNN_2D_model(np.array(X_pad[0]).shape)
...
print('\nTraining model...')
dl_models_final.train_model(model, X_train, y_train, ckp_filename='CNN_on_concat_pkl', epochs=27, validation_data=(X_test, y_test), patience=100)
