...
cnn_lstm = dl_models_final.init_cnn_lstm(input_shape=(8, 8, 1), time_per_move_shape=(1,))

print('\nTraining model...')
dl_models_final.train_model(cnn_lstm, [X_pad, time_pad], y, ckp_filename='new_cnn_lstm_on_concat_result_pkl', epochs=27, validation_split=.2, patience=100)
