...
if __name__ == "__main__":
    ...
    filepath = os.path.join('checkpoint', "new_cnn_lstm_on_concat_result_pkl.model.keras")
    utils.upload_parquet_to_gcp(bucket_name, filepath,"models/cnn_lstm.model.keras")
